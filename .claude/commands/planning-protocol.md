---
description: >
  Obliga a leer toda la documentación relevante y generar planes exhaustivos mapeados al DoD antes de codificar.
---
...
1. **Lectura del Contexto Maestro (Sin excepciones)**:
   - Ejecuta el comando `/check-docs` para encontrar los flujos y entidades relevantes.
   - **CRÍTICO**: Lee `docs/development-plan.md`. Extrae las Tareas y el "Definition of Done" (DoD) de la sección del Bloque activo.
   - **CRÍTICO**: Lee `docs/screen-specs.md`. Domina el comportamiento UI, estados, constraints de diseño y lineamientos de UX Writing de las pantallas del bloque.
