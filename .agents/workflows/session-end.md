...
3. **Actualización de Estado:** Usa la herramienta `replace_file_content` para actualizar el archivo `.planning/STATE.md`:
...
4. **Commit:** (Opcional, sujeto a instrucción del usuario) Si el usuario lo permite, prepara o sugiere el commit de cierre estilo "chore: session-end [bloque]".
